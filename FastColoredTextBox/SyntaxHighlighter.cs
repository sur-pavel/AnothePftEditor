...
namespace FastColoredTextBoxNS
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        public readonly Style BlueVioletStyle = new TextStyle(Brushes.BlueViolet, null, FontStyle.Bold);
        ...
        protected Regex PftFieldRegex;
        protected Regex PftUniforRegex;
        protected Regex PftSubFieldRegex;
        protected Regex PftStringRegex;
        ...
        public virtual void AutoIndentNeeded(object sender, AutoIndentEventArgs args)
        {
            ...
            switch (language)
            {
                ...
                case Language.JS:
                    ...
                    break; //JS like C#
                case Language.Pft:
                    PftAutoIndentNeeded(sender, args);
                    break; //JS like C#
                case Language.Lua:
...
//            range.SetStyle(FieldStyle, PftSubFieldRegex);
            //keyword highlighting
            range.SetStyle(KeywordStyle, PftKeywordRegex);
            //clear folding markers
            range.ClearFoldingMarkers();
            //set folding markers
            range.SetFoldingMarkers("{", "}"); //allow to collapse brackets block
...
";
        ...
        /// unifor style
        /// </summary>
        public Style UniforStyle { get; set; }
